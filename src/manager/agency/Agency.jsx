...
import AgencyModel from "./AgencyModel.json";
...
export default class Agency extends Component {
    ...
    constructor(props) {
        ...
        let store = new Store({
            ...
            idField: Agency.idField,
            autoLoad: true
        });

        this.state = {
            fields: AgencyModel.fields,
            store: store,
            showModal: false,
            item: {}
        };
        ...
        this.__onSave = this.__onSave.bind(this);
        this.__edit = this.__edit.bind(this);
